package com.sample.project.events.config;
...
@ComponentScan("com.sample.project.events.persist")
@EnableJpaRepositories("com.sample.project.events.persist")
...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        factoryBean.setPackagesToScan("com.sample.project.events.persist");
